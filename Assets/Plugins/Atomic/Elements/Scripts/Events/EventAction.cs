...
namespace Atomic.Elements
{
    ...
    [Serializable]
    public class EventAction : IEvent, IDisposable
    {
    ...
    [Serializable]
    public class EventAction<T> : IEvent<T>, IDisposable
    {
    ...
    [Serializable]
    public class EventAction<T1, T2> : IEvent<T1, T2>, IDisposable
    {
    ...
    [Serializable]
    public class EventAction<T1, T2, T3> : IEvent<T1, T2, T3>, IDisposable
    {
