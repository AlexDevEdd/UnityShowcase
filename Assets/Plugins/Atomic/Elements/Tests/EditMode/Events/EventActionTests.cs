...
{
    public sealed class EventActionTests
    {
        [Test]
    ...
    public sealed class EventT1Tests
    {
        ...
        public void Subscribe()
        {
            ...
            var eventBase = new EventAction<object>();
        ...
        public void Dispose()
        {
            ...
            //Arrange:
            var eventBase = new EventAction<string>();
            eventBase.OnEvent += OnEventRaisen1;
            eventBase.Subscribe(OnEventRaisen2);
    ...
    public sealed class EventT2Tests
    {
        ...
        public void Subscribe()
        {
            ...
            var eventBase = new EventAction<object, int>();
        ...
        public void Dispose()
        {
            ...
            //Arrange:
            var eventBase = new EventAction<string, int>();
            eventBase.OnEvent += OnEventRaisen;
    ...
    public sealed class EventT3Tests
    {
        ...
        public void Subscribe()
        {
            ...
            var eventBase = new EventAction<object, int, bool>();
        ...
        public void Dispose()
        {
            ...
            //Arrange:
            var eventBase = new EventAction<string, int, bool>();
            eventBase.OnEvent += OnEventRaisen;
